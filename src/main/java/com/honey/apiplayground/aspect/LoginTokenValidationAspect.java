package com.honey.apiplayground.aspect;

import com.honey.apiplayground.service.TokenService;
...
public class LoginTokenValidationAspect {
    ...
    @Before("@annotation(com.honey.apiplayground.annotation.RequiresLoginTokenValidation)")
